...
describe('MoondreamClient', () => {
    ...
    beforeEach(() => {
        ...
        client = new moondream_1.vl(moondreamConfig);
        jest.clearAllMocks();
    });
    describe('caption', () => {
        it('should successfully get a caption for an image buffer', async () => {
            ...
            expect(mockedFetch).toHaveBeenCalledWith('https://api.moondream.ai/v1/caption', expect.objectContaining({
                method: 'POST',
                headers: {
    ...
    describe('query', () => {
        it('should successfully query about an image', async () => {
            ...
            expect(mockedFetch).toHaveBeenCalledWith('https://api.moondream.ai/v1/query', expect.objectContaining({
                method: 'POST',
                headers: {
                    'X-Moondream-Auth': mockApiKey,
                    'Content-Type': 'application/json',
    ...
    describe('detect', () => {
        it('should successfully detect objects in an image', async () => {
            ...
            expect(mockedFetch).toHaveBeenCalledWith('https://api.moondream.ai/v1/detect', expect.objectContaining({
                method: 'POST',
                headers: {
                    'X-Moondream-Auth': mockApiKey,
                    'Content-Type': 'application/json',
    ...
    describe('encodeImage', () => {
        it('should pass through already encoded images', async () => {
            const result = await client.encodeImage(mockBase64Image);
            expect(result).toBe(mockBase64Image);
        });
        it('should encode image buffers', async () => {
            const result = await client.encodeImage(mockImageBuffer);
        ...
        it('should handle encoding errors', async () => {
            ...
            await expect(client.encodeImage(invalidBuffer))
                .rejects
    ...
    describe('point', () => {
        it('should successfully point to objects in an image', async () => {
            ...
            expect(mockedFetch).toHaveBeenCalledWith('https://api.moondream.ai/v1/point', expect.objectContaining({
                method: 'POST',
                headers: {
                    'X-Moondream-Auth': mockApiKey,
                    'Content-Type': 'application/json',
